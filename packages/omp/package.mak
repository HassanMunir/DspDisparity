...
package/%.xdc.inc package/%_omp.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package omp" (because $@ is older than $(firstword $?))" ...
...
package/rel/undefinedomppackage/package.rel.xml: package/package.cfg.xdc.inc
package/package.cfg.xdc.inc: $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	@$(MSG) generating schema include file list ...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js omp $@
...
.PHONY: release,omp
omp.zip: package/package.bld.xml
omp.zip: package/build.cfg
omp.zip: package/package.xdc.inc
omp.zip: package/package.cfg.xdc.inc
ifeq (,$(MK_NOGENDEPS))
-include package/rel/omp.zip.dep
endif
package/rel/omp/omp/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

omp.zip: package/rel/omp.xdc.inc package/rel/omp/omp/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELZIP,package/rel/omp.xdc.inc,package/rel/omp.zip.dep)


release release,omp: all omp.zip
clean:: .clean
	-$(RM) omp.zip
	-$(RM) package/rel/omp.xdc.inc
	-$(RM) package/rel/omp.zip.dep
